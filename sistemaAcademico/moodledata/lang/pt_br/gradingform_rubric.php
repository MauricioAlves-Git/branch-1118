...
$string['lockzeropoints_help'] = 'Essa configuração se aplica apenas se a soma do número mínimo de pontos para cada critério for maior que 0. Se marcado, a pontuação mínima da atividade será a nota mínima alcançável para a rubrica. Se desmarcado, a pontuação mínima possível para a rubrica será mapeada para a nota mínima disponível para a atividade (que é 0, a menos que uma escala seja usada).';
$string['name'] = 'Nome';
...
$string['previewrubric'] = 'Ver prévia da rubrica';
