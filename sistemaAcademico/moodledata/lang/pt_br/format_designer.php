...
/**
 * Strings for component 'format_designer', language 'pt_br', version '4.1'.
 *
...
$string['backtomaincourse'] = 'Voltar a página principal do curso';
...
$string['displayheaderroleusers'] = 'Escolha o papel da equipe';
$string['done'] = 'Feito';
$string['everywhere'] = 'Em todos os lugares';
$string['groupnotfound'] = 'Grupo não encontrado';
$string['heroactivity_help'] = 'O Designer dá aos professores a opção de tornar atividades específicas uma "atividade heróica". As atividades principais são adicionadas à navegação secundária para torná-las facilmente acessíveis aos estudantes.';
