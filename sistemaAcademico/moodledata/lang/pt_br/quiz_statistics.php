...
$string['getstatslockprogress'] = 'Aguardando tarefa em andamento. Por favor, aguarde ou tente novamente mais tarde.';
$string['getstatslocktimeout'] = 'Tempo limite do bloqueio de cálculo de estatísticas';
$string['getstatslocktimeoutdesc'] = 'Quantos segundos esperar por um bloqueio ao tentar realizar um cálculo de estatísticas para um questionário. Esta configuração existe principalmente para testes, não a modifique a menos que saiba o que está fazendo.';
...
$string['nostats'] = 'Não foi possível concluir o cálculo de estatísticas. Pode haver um cálculo em andamento de longa duração. Por favor, tente novamente mais tarde.';
...
$string['privacy:metadata'] = 'Embora o plugin de Estatísticas do Questionário tenha tabelas de banco de dados, os dados são dados agregados e não descrevem um indivíduo único.';
