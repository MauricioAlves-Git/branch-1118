...
$string['privacy:preference:unitgradingtypes'] = 'Se a penalidade de unidade se aplica como uma fração (0-1) da nota de resposta ou da nota de questão.';
$string['privacy:preference:unitpenalty'] = 'Qual fração (0-1) da nota de resposta ou da nota da questão deve ser aplicada?';
