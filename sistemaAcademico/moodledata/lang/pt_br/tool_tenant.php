...
$string['andxmoretenants'] = 'e {$a} mais...';
...
$string['autheditstatus'] = 'Editar status';
$string['authnewstatusfor'] = 'Novo status para {$a}';
$string['basicinformation'] = 'Informações básicas';
$string['brand'] = 'Cor primária';
...
$string['changesite'] = 'Alterar site';
$string['chooseexistingcategory'] = 'Escolher uma categoria existente';
$string['colours'] = 'Cores';
$string['configoverride'] = 'Sobrepor';
$string['configusedefault'] = 'Utilizar o padrão';
...
$string['confirmresendemailuser'] = 'Tem a certeza de que deseja reenviar um e-mail de confirmação a este usuário?';
...
$string['confirmuser'] = 'Confirmar usuário';
$string['confirmusers'] = 'Confirmar usuários';
...
$string['editdashboarddescription'] = 'Editar o painel apenas para este tenant.';
...
$string['emailsconfirmationresend'] = 'Reenviar e-mails de confirmação';
...
$string['errortenantarchived'] = 'Este tenant foi arquivado';
$string['errortenantnotfound'] = 'Este tenant não existe';
...
$string['lookingfordifferentsite'] = 'Procurando por um site diferente?';
...
$string['modurl:tenantid'] = 'ID do Tenant';
$string['modurl:tenantidnumber'] = 'Número de ID do Tenant';
...
$string['notavailablefortenants'] = 'Não disponível em nenhum tenant';
$string['notnow'] = 'Não agora';
$string['notspecified'] = 'Não especificado';
$string['oauth2availableforlogin'] = 'Serviços OAuth 2 disponíveis para login.';
$string['organisationadmintab'] = 'Organização';
$string['outcomeallocation'] = 'Alocar usuários ao tenant';
$string['outcomeallocationdescription'] = 'Alocar usuários ao tenant \'{$a}\'';
...
$string['resendemailuser'] = 'Reenviar o e-mail ao usuário';
$string['resetappearance'] = 'Redefinir a aparência';
$string['resetdashboard'] = 'Redefinir o painel para todos os usuários...';
$string['resettenantappearance'] = 'Redefinir a aparência do tenant';
$string['resettenantappearancecolours'] = 'Redefinir todas as cores personalizadas';
$string['resettenantappearancecss'] = 'Apagar SCSS personalizado';
$string['restoretenant'] = 'Restaurar tenant';
$string['seealltenants'] = 'Ver tudo';
$string['selecttenant'] = 'Selecionar tenant';
$string['selecttenantoutcome'] = 'Selecione o tenant';
$string['selecttenants'] = 'Selecione os tenants';
...
$string['tenantadmins'] = 'Administradores de tenant';
$string['tenantavailability'] = 'Editar a disponibilidade do tenant';
...
$string['tenantusers'] = 'Usuários do tenant';
...
$string['userconfirmedsuccess'] = '{$a} usuário(s) confirmado(s)';
...
$string['usertenant'] = 'Tenant do usuário';
