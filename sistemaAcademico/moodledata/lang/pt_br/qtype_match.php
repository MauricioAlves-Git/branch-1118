...
$string['privacy:metadata'] = 'O plugin do tipo de questão Correspondência permite que os autores de questões definam opções padrão como preferências do usuário.';
