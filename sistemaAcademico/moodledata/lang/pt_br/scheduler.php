...
$string['confirmrevoke'] = 'Revogar todos os compromissos no slot atual?';
...
$string['exporttimerangeall'] = 'Slots futuros e passados';
$string['exporttimerangefuture'] = 'Somente slots futuros';
$string['exporttimerangepast'] = 'Somente slots passados';
...
$string['limited'] = 'Limitado ({$a} restante)';
...
$string['negativetimerange'] = 'O horário de término deve ser posterior ao horário de início.';
$string['never'] = 'Nunca';
...
$string['privacy:metadata:filepurpose'] = 'Arquivo usado em anotações para o slot ou compromisso';
$string['privacy:metadata:scheduler_appointment'] = 'Representa um compromisso do aluno em uma agenda';
$string['privacy:metadata:scheduler_appointment:appointmentnote'] = 'Observação do professor (visível para o aluno)';
$string['privacy:metadata:scheduler_appointment:appointmentnoteformat'] = 'Formato da observação do professor';
$string['privacy:metadata:scheduler_appointment:attended'] = 'Se o compromisso foi atendido';
$string['privacy:metadata:scheduler_appointment:grade'] = 'Nota para o compromisso';
$string['privacy:metadata:scheduler_appointment:studentid'] = 'Aluno que agendou a consulta';
$string['privacy:metadata:scheduler_appointment:studentnote'] = 'Observação do aluno';
$string['privacy:metadata:scheduler_appointment:studentnoteformat'] = 'Formato da observação do estudante';
$string['privacy:metadata:scheduler_appointment:teachernote'] = 'Observação do professor (privada)';
$string['privacy:metadata:scheduler_appointment:teachernoteformat'] = 'Formato da observação privada do professor';
$string['privacy:metadata:scheduler_slots'] = 'Representa um slot em um agendador';
$string['privacy:metadata:scheduler_slots:appointmentlocation'] = 'Local do agendamento';
$string['privacy:metadata:scheduler_slots:duration'] = 'Duração do slot em minutos';
$string['privacy:metadata:scheduler_slots:exclusivity'] = 'Número máximo de alunos no slot';
$string['privacy:metadata:scheduler_slots:notes'] = 'Observações sobre o slot';
$string['privacy:metadata:scheduler_slots:notesformat'] = 'Formato das observações';
$string['privacy:metadata:scheduler_slots:starttime'] = 'Hora de início do slot';
$string['privacy:metadata:scheduler_slots:teacherid'] = 'Professor associado ao slot';
...
$string['revealteachernotes'] = 'Revelar observações do professor em exportações de privacidade';
$string['revealteachernotes_desc'] = 'Se essa opção for selecionada, as observações privadas do professor (que normalmente não são visíveis para os alunos) serão reveladas aos alunos em solicitações de exportação de dados, ou seja, por meio da API de privacidade. Você deve decidir, com base no uso individual desse campo, se ele precisa ser incluído nas exportações de dados para os alunos de acordo com a LGPD.';
...
$string['scheduler:editallattended'] = 'Marcar os alunos em todos os compromissos como atendidos/não atendidos.';
$string['scheduler:editallgrades'] = 'Editar notas em todos os compromissos.';
$string['scheduler:editallnotes'] = 'Editar observações de compromissos em todos os compromissos.';
