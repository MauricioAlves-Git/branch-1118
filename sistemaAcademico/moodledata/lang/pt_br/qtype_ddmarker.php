...
$string['formerror_dragrequired'] = 'Você deve adicionar pelo menos um marcador a esta questão.';
$string['formerror_droprequired'] = 'Você deve definir pelo menos uma região alvo para esta questão.';
...
$string['formerror_noitemselected'] = 'Você especificou uma área para soltar, mas não escolheu um marcador que deve ser arrastado para essa região alvo.';
...
$string['previewareaheader'] = 'Prévia';
