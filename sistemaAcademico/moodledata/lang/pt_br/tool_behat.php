...
$string['fieldvalueargument_help'] = 'Este argumento deve ser preenchido por um valor de campo. Existem muitos tipos de campo, incluindo os mais simples como caixas de seleção, menu suspensos ou áreas de texto ou mais complexos, como seletores de data. Consulte a documentação de desenvolvedor <a href="https://moodledev.io/general/development/tools/behat" target="_blank">Teste de aceitação</a> para ver detalhes dos valores esperados do tipo de campo.';
