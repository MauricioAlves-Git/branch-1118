...
$string['privacy:preference:showstandardinstruction'] = 'Se as instruções padrão devem ser exibidas.';
...
$string['showstandardinstruction_help'] = 'Se as instruções "Escolha uma:" ou "Escolha uma ou mais:" devem ser exibidas antes das respostas de múltipla escolha. Como alternativa, você pode incluir instruções no texto da questão.';
