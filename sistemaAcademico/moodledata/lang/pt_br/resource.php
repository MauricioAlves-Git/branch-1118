...
$string['clicktoopen2'] = 'Clique no link {$a} para ver o arquivo.';
...
$string['indicator:socialbreadth_help'] = 'Este indicador baseia-se no engajamento social alcançado pelo estudante em um recurso Arquivo.';
