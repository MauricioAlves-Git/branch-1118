...
$string['certlifetime_help'] = 'Isso define por quanto tempo você deseja manter os certificados emitidos. Os certificados emitidos com idade superior a esse tempo são excluídos automaticamente.';
$string['code'] = 'Código';
$string['codex'] = 'Posição Horizontal do QR Code do Certificado';
$string['codey'] = 'Posição Vertical do QR Code do Certificado';
$string['completedusers'] = 'Usuários que atenderam às condições de atividade';
...
$string['defaultcertificatetextx'] = 'Posição de texto horizontal padrão';
...
$string['emailoncompletion'] = 'Email na conclusão do curso';
...
<ul>
<li>Nota percentual: imprime a nota como uma porcentagem.</li>
<li>Nota de pontos: imprime o valor de pontos da nota.</li>
<li>Nota em letra: imprime a nota percentual em forma de letra.</li>
</ul>';
...
$string['nodelivering'] = 'Sem entrega, o usuário receberá este certificado de outras maneiras';
...
$string['size_help'] = 'Estes são os tamanhos de largura e altura (em milímetros) do certificado. O tamanho padrão é A4 Paisagem';
