...
$string['deletepreviouslyapplied'] = 'Esta predefinição foi aplicada anteriormente. Excluir uma predefinição a remove completamente do seu site. Você não poderá reverter suas configurações para como eram antes de aplicar esta predefinição.';
