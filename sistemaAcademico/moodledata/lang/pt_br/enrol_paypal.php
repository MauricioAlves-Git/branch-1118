...
$string['privacy:metadata:enrol_paypal:enrol_paypal:payment_type'] = 'Mantém se o pagamento foi financiado com um eCheck (echeck) ou foi financiado com saldo do PayPal, cartão de crédito ou transferência instantânea (instantânea).';
