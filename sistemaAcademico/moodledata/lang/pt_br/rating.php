...
$string['noviewrate'] = 'Você não tem a capacidade para ver avaliações de itens';
...
$string['rolewarning_help'] = 'Papéis com permissão para avaliar, são os papéis com a capacidade moodle/rating:rate mais quaisquer permissões de avaliação específicas da atividade. Você pode dar permissão de avaliar para mais papéis por meio da página Permissões.';
