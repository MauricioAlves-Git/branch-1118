...
$string['mandatoryofflinespecifycourse'] = 'Seleção obrigatória de curso';
$string['mandatoryofflinespecifycourse_help'] = 'Especificar um curso em sessões offline será obrigatório';
