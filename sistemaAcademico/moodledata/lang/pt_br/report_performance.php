...
$string['check_debugmsg_details'] = 'Raramente há vantagem em ir para o nível de Desenvolvedor, a menos que solicitado por um desenvolvedor.<p>Depois de obter a mensagem de erro e copiá-la e colá-la em algum lugar, é ALTAMENTE RECOMENDADO voltar o Debug para NENHUM. As mensagens de debug podem dar pistas a um invasor sobre a configuração do seu site e podem afetar o desempenho.</p>';
