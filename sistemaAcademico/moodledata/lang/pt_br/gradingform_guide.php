...
$string['privacy:metadata:criterionid'] = 'Um identificador para um critério de avaliação avançada.';
...
$string['privacy:metadata:preference:showmarkerdesc'] = 'Se devem ser mostradas descrições de critérios do avaliador';
$string['privacy:metadata:preference:showstudentdesc'] = 'Se deve mostrar descrições de critérios do estudante';
$string['privacy:metadata:remark'] = 'Observações relacionadas a este critério de nota.';
