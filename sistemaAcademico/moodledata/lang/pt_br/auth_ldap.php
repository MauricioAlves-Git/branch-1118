...
$string['cannotmaprole'] = 'O papel "{$a->rolename}" não pode ser mapeado porque seu nome curto "{$a->shortname}" é muito longo e/ou contem hífen. Para permitir que ele seja mapeado, seu nome curto precisa ser reduzido ao máximo de {$a->charlimit} caracteres e ter todos os hífens excluídos. <a href="{$a->link}">Editar o papel</a>';
