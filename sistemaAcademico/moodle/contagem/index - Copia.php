...
<html lang="pt-BR">
  <head>
    ...
    <div class="container mt-5"> <!-- Aumente a margem aqui para descer a div -->
      <?php include('mensagem.php'); ?>
      <div class="row mt-4"> <!-- Aumentar margem superior dessa linha também -->
        <div class="col-md-12">
          <div class="card mt-3"> <!-- Adicionando margem superior aqui -->
